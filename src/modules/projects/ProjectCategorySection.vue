<template>
    <div :id="getIdFromAnchor(category.anchor)" class="anchored">
        <div class="dark-blob">
            ...
            <div v-for="project in getProjectsForCategory(category.id)" :key="project.id">
...
export default {
  ...
  methods: {
        ...
        getProjectsForCategory: function(categoryId) {
          return this.projects.filter(project => project.categoryId == categoryId);
        }
  }
};
</script>
